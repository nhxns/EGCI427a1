...
var PickChildrenAnalyzer_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
var PickChildrenAnalyzer = /** @class */ (function () {
    function PickChildrenAnalyzer(name) {
        this.name = name;
    }
    return PickChildrenAnalyzer;
}());
exports.PickChildrenAnalyzer = PickChildrenAnalyzer;

});

var SliceAnalyzer_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
var SliceAnalyzer = /** @class */ (function () {
    function SliceAnalyzer(from, to) {
        this.from = from;
        this.to = to;
    }
    return SliceAnalyzer;
}());
exports.SliceAnalyzer = SliceAnalyzer;

});

var AnalyzerType_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
(function (AnalyzerType) {
    AnalyzerType["Slice"] = "slice";
    AnalyzerType["PickChilren"] = "pickChildren";
})(exports.AnalyzerType || (exports.AnalyzerType = {}));

});

var AnalyzerUnit_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
var AnalyzerUnit = /** @class */ (function () {
    function AnalyzerUnit(type, content) {
        this.type = type;
        this.content = content;
    }
    return AnalyzerUnit;
}());
exports.AnalyzerUnit = AnalyzerUnit;
...
var jsquery$1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
function findArrayBoundary(boundary) {
    var startPoint = 0;
    var endPoint = 0;
    if (lodash.startsWith(boundary, '[')) {
        if (!lodash.endsWith(boundary, ']'))
...
var PickChildrenUnit = /** @class */ (function () {
    ...
    PickChildrenUnit.prototype.parse = function (input) {
        ...
        if (input instanceof Array && lodash.findIndex(input, function (v) { return (v instanceof Object) && !(v instanceof Array); }) > -1)
            return lodash.flatten(input.map(function (v) { return _this.pickItem(v); }));
    ...
    PickChildrenUnit.prototype.pickItem = function (source) {
        ...
        if (lodash.startsWith(this.key, 'reg:'))
...
var jsquery = createCommonjsModule(function (module, exports) {
function __export(m) {
    for (var p in m) if (!exports.hasOwnProperty(p)) exports[p] = m[p];
}
Object.defineProperty(exports, "__esModule", { value: true });
__export(PickChildrenAnalyzer_1);
__export(SliceAnalyzer_1);
__export(AnalyzerType_1);
__export(AnalyzerUnit_1);
__export(jsquery$1);

});

var index = /*@__PURE__*/getDefaultExportFromCjs(jsquery);
